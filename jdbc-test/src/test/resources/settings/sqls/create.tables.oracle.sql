...
CREATE TABLE TEST_SETTING (
	...
	DATA_STATE INTEGER DEFAULT 1 NOT NULL, 
...
CREATE TABLE "TEST_ROLE_CORE_INFO" (
   ...
   "CREATE_TIME"        TIMESTAMP            DEFAULT CURRENT_TIMESTAMP NOT NULL,
   "DEFAULTS"           SMALLINT             DEFAULT 0 NOT NULL,
   "OPTIONS"            CLOB,
...
CREATE TABLE "TEST_USER_CORE_INFO" (
   ...
   "CREATE_TIME"        TIMESTAMP            DEFAULT CURRENT_TIMESTAMP NOT NULL,
   "SUPERMAN"           SMALLINT             DEFAULT 0 NOT NULL,
   "USER_STATE"         SMALLINT             DEFAULT 0 NOT NULL,
   "USER_SOURCE"        SMALLINT             DEFAULT 0 NOT NULL,
   "OPTIONS"            CLOB,
   "DATA_STATE"         INTEGER              DEFAULT 0 NOT NULL,
   CONSTRAINT TEST_USER_CORE_PK PRIMARY KEY ("ID"),
   CONSTRAINT TEST_USER_CORE_CODE UNIQUE ("TENANT_CODE", "USER_TYPE", "USER_CODE", "DATA_STATE"),
   CONSTRAINT TEST_USER_CORE_NAME UNIQUE ("TENANT_CODE", "USER_TYPE", "USER_NAME", "DATA_STATE"),
   CONSTRAINT TEST_USER_CORE_PHONE UNIQUE ("TENANT_CODE", "USER_TYPE", "PHONE", "DATA_STATE"),
   CONSTRAINT TEST_USER_CORE_EMAIL UNIQUE ("TENANT_CODE", "USER_TYPE", "EMAIL", "DATA_STATE")
);
