 ...
 * @version 20200725
 */
public abstract class BaseEntityDataStatusFillStrategy<DS> implements EntityDataStatusFillStrategy<DS> {
    ...
    /** 处理逻辑删除时的数据状态 **/
    protected void putLogicalDeleteDataStatus(DbUpdate ud, String fieldName, Object dataIneffectiveFlag) {
